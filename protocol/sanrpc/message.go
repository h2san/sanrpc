...
var (
	// Compressors are compressors supported by sanrpc. You can add customized compressor in Compressors.
...
// CheckMagicNumber checks whether header starts sanrpc magic number.
func (h Header) CheckMagicNumber() bool {
	return h[0] == magicNumber
}

// Version returns version of sanrpc protocol.
